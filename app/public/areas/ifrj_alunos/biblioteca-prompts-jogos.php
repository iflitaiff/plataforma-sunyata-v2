<?php
/**
 * Gateway: Biblioteca de Prompts (Jogos)
...
// Verificar se tem acesso (vertical ifrj_alunos OU usuário demo)
...
try {
    ...
    $db->insert('tool_access_logs', [
        ...
        'tool_name' => 'Biblioteca Prompts Jogos',
        'tool_slug' => 'biblioteca-prompts-jogos',
...
$tool_html = __DIR__ . '/../../ferramentas/biblioteca-prompts-jogos.html';
...
<body>
    <div class="container mt-5">
        <div class="alert alert-danger">
            ...
            <a href="' . BASE_URL . '/areas/ifrj_alunos/" class="btn btn-primary">Voltar</a>
        </div>
    </div>
</body>
</html>';

...
$ferramentas = array (
  ...
  array (
    'id' => 'canvas-docente',
    'nome' => 'Canvas Docente',
    'descricao' => 'Planejamento estruturado de aulas e atividades pedagógicas',
    'icone' => '📋',
  ),
  1 => 
  array (
  ...
  array (
    ...
    'descricao' => 'Coleção de prompts para gamificação educacional',
    'icone' => '🎮',
  ),
  3 => 
  array (
    ...
    'descricao' => 'Guia prático para criação de prompts em jogos educativos',
    'icone' => '📖',
  ),
  4 => 
  array (
...
foreach ($ferramentas as &$ferramenta) {
    $ferramenta['url'] = BASE_URL . "/areas/docencia/{$ferramenta['id']}.php";
}
unset($ferramenta); // Importante: liberar a referência para evitar bugs

$pageTitle = 'Vertical: Docência';
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
            ...
            <div class="row">
                <div class="col-12">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h1>👨‍🏫 Docência</h1>
                            <p class="lead mb-0">Ferramentas para planejamento de aulas e gestão pedagógica</p>
                        </div>

<?php
/**
 * Gateway: Padrões Avançados (Jurídico)
...
try {
    ...
    $db->insert('tool_access_logs', [
        ...
        'tool_name' => 'Padroes Avancados Juridico',
        'tool_slug' => 'padroes-avancados-juridico',
...
$tool_html = __DIR__ . '/../../ferramentas/padroes-avancados-juridico.html';
...
<body>
    <div class="container mt-5">
        <div class="alert alert-danger">
            ...
            <a href="' . BASE_URL . '/areas/juridico/" class="btn btn-primary">Voltar</a>
        </div>
    </div>
</body>
</html>';

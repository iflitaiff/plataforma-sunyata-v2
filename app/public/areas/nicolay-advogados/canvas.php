<?php
/**
 * Nicolay Advogados - Visualizar Formulários de um Canvas
...
$canvas = $db->fetchOne("
    SELECT * FROM canvas
    WHERE id = :id AND vertical = 'nicolay-advogados' AND is_active = 1
", ['id' => $canvas_id]);
...
<body>
    <div class="container container-custom">
        ...
        <div class="row">
            ...
            <?php else: ?>
                <?php foreach ($formularios as $form): ?>
                    <div class="col-md-6">
                        <a href="<?= BASE_URL ?>/areas/nicolay-advogados/formulario.php?template=<?= $form['slug'] ?>" class="form-card">
        ...
        <div class="nav-buttons">
            <a href="<?= BASE_URL ?>/areas/nicolay-advogados/index.php" class="btn btn-light me-2">
                ← Voltar para Canvas
            </a>

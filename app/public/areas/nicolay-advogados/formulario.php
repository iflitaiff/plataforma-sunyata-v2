...
<body>
    <div class="container-custom">
        ...
        <div id="resultContainer">
            ...
            <a href="<?= BASE_URL ?>/areas/nicolay-advogados/index.php" class="btn btn-secondary btn-voltar">
                ← Voltar
            </a>
        </div>
        ...
        <div id="errorContainer" style="display: none;">
            <div class="alert alert-warning border-start border-4 border-warning" style="border-radius: 10px;">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    ...
                    <a href="<?= BASE_URL ?>/areas/nicolay-advogados/index.php" class="btn btn-outline-secondary">

<?php
/**
 * Legal - Menu Principal
 * Vertical dedicada para escritório Legal
 */
...
$verticalName = $verticalData['name'] ?? 'Legal';
                ...
                <?php foreach ($canvas_list as $canvas): ?>
                    <div class="col-md-12">
                        ...
                        if ($canvas['type'] === 'forms') {
                            $canvas_url = BASE_URL . "/areas/legal/formulario.php?template=" . $canvas['slug'];

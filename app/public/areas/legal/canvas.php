<?php
/**
 * Legal - Visualizar Formulários de um Canvas
...
<body>
    <div class="container container-custom">
        ...
        <div class="row">
            ...
            <?php else: ?>
                <?php foreach ($formularios as $form): ?>
                    <div class="col-md-6">
                        <a href="<?= BASE_URL ?>/areas/legal/formulario.php?template=<?= $form['slug'] ?>" class="form-card">
        ...
        <div class="nav-buttons">
            <a href="<?= BASE_URL ?>/areas/legal/index.php" class="btn btn-light me-2">
                ← Voltar para Canvas
            </a>

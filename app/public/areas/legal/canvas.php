...
$template = $db->fetchOne("
    ...
    WHERE ct.id = :id AND cva.vertical_slug = 'legal' AND ct.is_active = TRUE
", ['id' => $canvas_id]);
...
redirect(BASE_URL . '/areas/legal/formulario.php?template=' . $template['slug']);

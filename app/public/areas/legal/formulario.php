<?php
/**
 * Legal - Renderizar Formulário SurveyJS
...
if ($user_vertical !== 'legal' && !$is_demo && !$is_admin) {
...
if (!$template_slug) {
    ...
    redirect(BASE_URL . '/areas/legal/index.php');
}
...
<body>
    <div class="container-custom">
        ...
        <div class="canvas-nav">
            <div class="d-flex justify-content-between align-items-center flex-wrap">
                <div>
                    ...
                    if ($canvas['canvas_id']):
                    ?>
                    <a href="<?= BASE_URL ?>/areas/legal/canvas.php?id=<?= $canvas['canvas_id'] ?>" class="btn btn-sm btn-outline-secondary">
                        ← Voltar para Canvas
                    </a>
                    <?php else: ?>
        ...
        <div id="resultContainer">
            ...
            <a href="<?= BASE_URL ?>/areas/legal/canvas.php?id=<?= $canvas['canvas_id'] ?>" class="btn btn-secondary btn-voltar">
                📋 Voltar ao Canvas
            </a>
            <?php endif; ?>
        </div>
        ...
        <div id="errorContainer" style="display: none;">
            <div class="alert alert-warning border-start border-4 border-warning" style="border-radius: 10px;">
                ...
                <div class="d-flex gap-2 flex-wrap">
                    ...
                    <?php if ($canvas['canvas_id']): ?>
                    <a href="<?= BASE_URL ?>/areas/legal/canvas.php?id=<?= $canvas['canvas_id'] ?>" class="btn btn-outline-secondary">
                                ...
                                try {
                                    const response = await fetch('<?= BASE_URL ?>/api/canvas/export-pdf.php', {
                                        ...
                                        body: JSON.stringify({
                                            ...
                                            filename: 'analise-legal-' + Date.now() + '.pdf'
                                        })
                                    });
                                    ...
                                    a.href = url;
                                    a.download = 'analise-legal-' + Date.now() + '.pdf';

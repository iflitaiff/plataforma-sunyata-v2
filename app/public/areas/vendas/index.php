...
$pageTitle = 'Vertical: Vendas - Em Breve';
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
                ...
                <div class="col-md-8 col-lg-6">
                    <div class="card shadow-lg">
                        <div class="card-body text-center p-5">
                            ...
                            <p class="text-muted lead mb-4">Ferramentas para otimizar processos de vendas e relacionamento com clientes</p>

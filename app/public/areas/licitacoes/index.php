<?php
/**
 * Área Licitações - Menu Principal
 * Ferramentas para análise de editais e monitoramento de licitações
 */
...
$verticalData = $db->fetchOne("
    ...
    WHERE slug = 'licitacoes' AND is_active = TRUE
");
...
$categoryMeta = [
    ...
    'ferramentas' => ['label' => 'Ferramentas',                 'icon' => 'bi-tools',            'color' => '#fd7e14'],
                    ...
                    <div class="row">
                        <?php foreach ($items as $canvas): ?>
                            ...
                            if ($canvas['type'] === 'forms') {
                                $canvas_url = BASE_URL . "/areas/licitacoes/formulario.php?template=" . $canvas['slug'];

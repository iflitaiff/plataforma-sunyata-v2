...
$pageTitle = 'Vertical: Licitações - Em Breve';
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
                ...
                <div class="col-md-8 col-lg-6">
                    <div class="card shadow-lg">
                        <div class="card-body text-center p-5">
                            ...
                            <h1 class="mb-3">Licitações</h1>
                            <p class="text-muted lead mb-4">Ferramentas para elaboração de propostas e gestão de processos licitatórios</p>

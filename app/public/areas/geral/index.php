...
$pageTitle = 'Vertical: Geral - Em Breve';
?>
<!DOCTYPE html>
<html lang="pt-BR">
<head>
                ...
                <div class="col-md-8 col-lg-6">
                    <div class="card shadow-lg">
                        <div class="card-body text-center p-5">
                            ...
                            <h1 class="mb-3">Geral</h1>
                            <p class="text-muted lead mb-4">Ferramentas de propósito geral para diversas áreas e aplicações</p>

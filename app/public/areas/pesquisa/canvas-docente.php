...
// Verificar se tem acesso (vertical pesquisa OU usuário demo)
...
try {
    ...
    $db->insert('tool_access_logs', [
        ...
        'tool_name' => 'Canvas Docente',
        'tool_slug' => 'canvas-docente',
...
$tool_html = __DIR__ . '/../../ferramentas/canvas-docente.html';
...
<body>
    <div class="container mt-5">
        <div class="alert alert-danger">
            ...
            <a href="' . BASE_URL . '/areas/pesquisa/" class="btn btn-primary">Voltar</a>
        </div>
    </div>
</body>
</html>';
